...
// 2023-04-22 03:49:47.856426100 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1682135387;
namespace netvars {
...
constexpr ::std::ptrdiff_t client_state_deref = 0xFC040010;
...
constexpr ::std::ptrdiff_t dwDrawOtherModels = 0x1D1066;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2B3F0090;
