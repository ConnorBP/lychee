...
// 2023-04-13 02:53:08.941579900 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1681354388;
namespace netvars {
...
constexpr ::std::ptrdiff_t client_state_deref = 0xFC010010;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x26D30090;
