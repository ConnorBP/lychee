...
// 2023-05-14 04:51:04.978101500 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1684039864;
namespace netvars {
...
constexpr ::std::ptrdiff_t client_state_deref = 0xFC420010;
...
constexpr ::std::ptrdiff_t dwDrawOtherModels = 0x1D0676;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2B2DF630;
